...
public class Update extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(916, 491));
        setResizable(false);
        ...
        departmentcombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SWE", "CSE", "Textile", "BBA", "TE", "MBA", "LAW" }));
        ...
        facultycombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "FSIT", "FISS", "FIST" }));
        ...
        setSize(new java.awt.Dimension(915, 489));
